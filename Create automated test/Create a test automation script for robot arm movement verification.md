...
* Benchmark my approach: My internal time tracking says that I've put in around 12 hours of work before shrink-wrapping this assignment up (for both tasks combined, including breaks). That's a bit of an overrun over the intended 6-8 hours and there are clearly some loose ends in this work that'd need to tie up before I'd be comfortable calling this one of my flagship project examples. I am not exactly sure why I didn't spot this straight-up, probably I've underestimated the size of the VISTA control panel, and spent a bit too much time going a bit too deep (compared to the size of the assignment) when I was specifying the test cases for it.